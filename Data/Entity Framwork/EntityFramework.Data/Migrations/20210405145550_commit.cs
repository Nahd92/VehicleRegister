    ...
    public partial class commit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutoMotive", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDrivingBan = table.Column<bool>(type: "bit", nullable: false),
                    IsServiceBooked = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceReservations_AutoMotive_AutoMotiveRepairId",
                        column: x => x.AutoMotiveRepairId,
                        principalTable: "AutoMotive",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceReservations_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleServiceHistory_AutoMotive_AutoMotiveRepairId",
                        column: x => x.AutoMotiveRepairId,
                        principalTable: "AutoMotive",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
